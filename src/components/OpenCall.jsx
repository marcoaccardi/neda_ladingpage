      ...
      <div className='opencall__container'>
        ...
        <div className='opencall__container-text'>
          ...
          <p>
            ...
            host a two days event in each of the following cities: Amsterdam,
            ...
            receive a prize and compensation to take part in the events with
            their projects.The main theme for this open call is Artificial
            Intelligence (AI). AI is at the core of the fourth industrial
            revolution, it is the source and the main consumer of data in this
            new digital era. AI tools and systems will be integrated in our
            daily lives in the public and private space, in the workplace, and
            in classrooms. This will further develop as AI is progressively
            becoming a key complementary player to the human workforce.
          </p>
        </div>
      </div>
